  ...
  function ourReducer(draft, action) {
    switch (action.type) {
      ...
      case "setEthereumProviders":
        let infuraProvider = new ethers.InfuraProvider(1, process.env.INFURA)
        let infuraTestnetProvider = new ethers.InfuraProvider(5, process.env.INFURA)
      ...
      case "constructPsbtInputOutput":
        ...
        draft.bitcoin.txBuilder.psbt = psbt
      ...
      case "setCurrentBalance":
        ...
        return
      case "setChainId":
        draft.ethereum.txBuilder.txDataStruct.chainId = action.value
        return
      case "setTxType":
        draft.ethereum.txBuilder.txDataStruct.type = action.value
        return
      case "setTxTo":
        draft.ethereum.txBuilder.txDataStruct.to = action.value
        return
      case "setTxData":
      ...
      case "setValue":
        ...
        return
      case "signEthTx":
        let signedResult = draft.ethereum.txBuilder.wallet.signingKey.sign(draft.ethereum.txBuilder.txDataStruct.unsignedHash)
        draft.ethereum.txBuilder.txDataStruct.signature = signedResult
        return
      ...
      case "setNewTokenToErc20OwnedArray":
        if (draft.ethereum.erc20_owned_Array == null) {
          draft.ethereum.erc20_owned_Array = []
      ...
      case "setNewTokenToErc20DisplayOwnedArray":
        if (draft.ethereum.erc20_displayOwned_Array == null) {
          draft.ethereum.erc20_displayOwned_Array = []
              ...
              <BrowserRouter>
                ...
                <Suspense fallback={<LazyLoadFallback />}>
                  <Routes>
                    ...
                    <Route path="/" element={<WalletConnect_Main />} />
