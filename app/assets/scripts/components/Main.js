    ...
    <>
      {page == 2 ? (
        ...
        <>
          ...
          <IconContext.Provider value={{ size: "1.5rem" }}>
            <div className="interface__block">
              ...
              <div className="interface__block-cell">
                {showHash160 ? (
                  <>
                    ...
                    <Tooltip id="static_hash160" style={{ fontSize: "0.6rem" }} variant="info" />
                  ...
                  <>
                    ...
                    <Tooltip id="static_pubKey" style={{ fontSize: "0.6rem" }} variant="info" />
              ...
              <div className="interface__block-cell">
                ...
                <Tooltip id="hash160-button" style={{ fontSize: "0.7rem" }} variant="info" />
              </div>
            </div>
            <div className="interface__block">
          ...
          <Tooltip anchorSelect="#Tooltip" style={{ fontSize: "0.7rem" }} variant="info" />
        </>
      )}
    </>
  )
